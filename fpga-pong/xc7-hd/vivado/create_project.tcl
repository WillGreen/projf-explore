...
set design_sources [list \
  ...
  [file normalize "${common_dir}/display_timings_1080p.sv"] \
  ...
  [file normalize "${common_dir}/xc7-hd/clock_gen_sys.sv"] \
...
#   [file normalize "${common_dir}/xc7-hd/display_timings_1080p_tb.sv"] \
#   [file normalize "${common_dir}/xc7-hd/clock_gen_pix_tb.sv"] \
#   [file normalize "${common_dir}/xc7-hd/clock_gen_sys_tb.sv"] \
# ]
# add_files -norecurse -fileset $fs_sim_obj $sim_sources

# # Set 'sim_1' fileset properties
# set_property -name "top" -value "display_timings_1080p_tb" -objects $fs_sim_obj
